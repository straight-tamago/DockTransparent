...
struct ContentView: View {
    ...
    @State private var TargetFilesPath = [
        TargetFilesPath_Struct(
            title: "dockDark.materialrecipe",
            path: "/System/Library/PrivateFrameworks/CoreMaterial.framework/dockDark.materialrecipe"
        ),
        TargetFilesPath_Struct(
            title: "dockLight.materialrecipe",
            path: "/System/Library/PrivateFrameworks/CoreMaterial.framework/dockLight.materialrecipe"
        ),
    ]
    var body: some View {
        VStack {
            ...
            Text("DockTransparent").font(.largeTitle).fontWeight(.bold)
            ...
            HStack {
                ...
                Button {
                    ...
                    ActionSheet(title: Text("DockTransparent v\(version)"), message: Text("by straight-tamago"), buttons: [
                        .default(Text("Source Code")) {
                            if let url = URL(string: "https://github.com/straight-tamago/DockTransparent") {
                        ...
                        .default(Text("\(NSLocalizedString("Update Check", comment: ""))")) {
                            ...
                            let url = URL(string: "https://api.github.com/repos/straight-tamago/DockTransparent/releases/latest")
                ...
                .alert(isPresented: $Update_Alert) {
                    if Update_Available == true {
                        return Alert(title: Text("Update available"),
                            ...
                            if let url = URL(string: "https://github.com/straight-tamago/DockTransparent/releases") {
                                UIApplication.shared.open(url)
                            }
                        }),
                              secondaryButton: .default(Text("Cancel"))
